...
function main() {
    let goods = [
        new Good(33, "t-shirt", "empty", [35,36], 3000),
        new Good(35, "socks", "empty", [35,36], 2000),
        new Good(66, "gloves", "empty", [35,36], 5000),
        new Good(123, "hat", "empty", [35,36], 3500),
    ...
    let basketGoods = [
        new BasketGood(33, "t-shirt", "empty", [35,36], 3000, 20),
        new BasketGood(35, "socks", "empty", [35,36], 2000, 0),
        new BasketGood(66, "gloves", "empty", [35,36], 5000, 6),
        new BasketGood(123, "hat", "empty", [35,36], 3500, 1),
